  ...
  const onSelectKey = (e) => {
    ...
    axios.post('http://localhost:8000/docs/' + e.key, ['desc', 'params', 'docs', 'template', 'ret'], {
      ...
      .then(response => {
        ...
        var act_ret = details.ret
        if (details.ret === '_empty') {
          act_ret = details.ret + ' ( None )'
        }

        // tab1 - docs
        tabs.push({
          key: 'Docs', label: 'Docs', children: <div>
        ...
        //tab2 - args
        tabs.push({
          key: 'Args', label: 'Args', children: <div>
            ...
            <Flex gap='middle' style={{
              ...
              }} value={details.key} size='large' disabled />
              {/* onClick={runValidate} */}
              <Button type="primary" size='large' onClick={runValidate} >Validate</Button>
              {/* onClick={runExecute} */}
              <Button type="primary" size='large' onClick={runExecute} >Execute</Button>
            </Flex>
            ...
            <Row gutter={[16, 16]}>
              <Col span={12} >
                ...
                <Editor height="60vh" language="json" theme="vs-dark"
                  value={JSON.stringify([details.template], null, 2)} />
              </Col>
